							...
							<tr bgcolor="#4D595D">
								<td valign="top">
									...
									<div style="margin-top:8px"> 
										<textarea  cols="63" rows="30" style="width:99%;font-family:'Courier New', Courier, mono; font-size:13px; background:#475A5F;color:#FFFFFF" readonly="readonly" wrap="off"><% nvram_dump("wlan11b_2g.log","wlan11b.sh"); %></textarea>
									</div>
									<div class="apply_gen">

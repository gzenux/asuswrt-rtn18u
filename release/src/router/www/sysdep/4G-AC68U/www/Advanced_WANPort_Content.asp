	...
	<!-- -----------Enable Ping time watch dog start----------------------- -->			
				<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable" style="margin-top:8px;" id="watchdog_table">
					...
					<tr>
						...
						<td>
							<select name="wandog_maxfail" class="input_option" onchange="update_detection_time();add_option_count(document.form.wandog_interval, document.form.wandog_fb_count, document.form.wandog_fb_count.value);">

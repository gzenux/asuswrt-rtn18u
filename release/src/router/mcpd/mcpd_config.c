        ...
        *line = '\0';
        ...
        else if(strcasecmp(token, "mcast-max-groups-port-list") == 0)
        {
            ...
            while((ptr1) && (i < MAX_PORTS))
            {
                ...
                mcpd_router.max_group_port_list[i].maxPorts = strtoul(ptr1, NULL, 0);
                ptr1 = strtok_r(NULL, " ", &ptr2);
                ...
                if (0 == port_ifi) 
                {
                  ...
                  mcpd_router.max_group_port_list[i].brPortName[0] = '\0';
                  mcpd_router.max_group_port_list[i].maxPorts= 0;
                } 
                else 
                {
                         ...
                         t_MCPD_MLD_CONFIG *mld_config)
{
    ...
    for (i = 0 ; i < MAX_PORTS; i++)
    {
        ...
        {
            printf(" %s(%d),", mcpd_router.max_group_port_list[i].brPortName, mcpd_router.max_group_port_list[i].maxPorts);
        }
        else
        {
            break;

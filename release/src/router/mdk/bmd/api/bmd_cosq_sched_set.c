...
extern int _bd##_bmd_cosq_sched_set(int unit, bmd_cosq_sched_t sched_type, int sp_endq);
#include <bmdi/bmd_devlist.h>

/* Dispatch table for this function, which uses the externs above */
#define BMD_DEVLIST_ENTRY(_nm,_vn,_dv,_rv,_md,_pi,_bd,_bc,_fn,_fl,_cn,_pf,_pd,_r0,_r1) \
_bd##_bmd_cosq_sched_set,
static int (*__dispatch_table[])(int unit, bmd_cosq_sched_t sched_type, int sp_endq) =
{
#include <bmdi/bmd_devlist.h>
0
};
    ...
    int sp_endq)
{
    ...
    return __dispatch_table[dev_type](unit, sched_type, sp_endq);
}

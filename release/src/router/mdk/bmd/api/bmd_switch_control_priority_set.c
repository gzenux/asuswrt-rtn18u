...
extern int _bd##_bmd_switch_control_priority_set(int unit, int priority, bmd_switch_control_t type, int value);
#include <bmdi/bmd_devlist.h>

/* Dispatch table for this function, which uses the externs above */
#define BMD_DEVLIST_ENTRY(_nm,_vn,_dv,_rv,_md,_pi,_bd,_bc,_fn,_fl,_cn,_pf,_pd,_r0,_r1) \
_bd##_bmd_switch_control_priority_set,
static int (*__dispatch_table[])(int unit, int priority, bmd_switch_control_t type, int value) =
{
#include <bmdi/bmd_devlist.h>
0
};
...
int 
bmd_switch_control_priority_set(
    int unit, 
    int priority, 
    ...
    int value)
{
    ...
    return __dispatch_table[dev_type](unit, priority, type, value);
}

...
/*
 * $Id: bcm63100_a0_bmd_stat_clear.c,v 1.2 Broadcom SDK $
 * 
...
} bcm63100_a0_counter_t;

int
bcm63100_a0_bmd_stat_clear(int unit, int port, bmd_stat_t stat)
{
    int ioerr = 0;
    bcm63100_a0_counter_t ctr;

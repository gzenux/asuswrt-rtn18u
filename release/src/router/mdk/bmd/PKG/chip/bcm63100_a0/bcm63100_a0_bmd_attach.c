...
/*
 * $Id: bcm63100_a0_bmd_attach.c,v 1.1 Broadcom SDK $
 * 
...
static phy_bus_t *bcm63100_a0_phy_bus[] = {
...
static phy_bus_t *bcm63100_a0_ext_phy_bus[] = {
#ifdef PHY_BUS_BCM6368_MIIM_REG_INT_INSTALLED
    &phy_bus_bcm6368_miim_reg_int,
#endif
    NULL
};
...
#endif
int
bcm63100_a0_bmd_attach(int unit)
{
    int port;
    cdk_pbmp_t pbmp;
...
#if BMD_CONFIG_INCLUDE_PHY == 1
        if (CDK_DEV_FLAGS(unit) & CDK_DEV_MBUS_MII) {
            bmd_phy_bus_set(unit, port, bcm63100_a0_ext_phy_bus);
        } else {
            bmd_phy_bus_set(unit, port, bcm63100_a0_phy_bus);
        }
#endif
    }

...
/*
 * $Id: bcm6300_a0_bmd_attach.c,v 1.5 Broadcom SDK $
 * 
...
static phy_bus_t *bcm6300_a0_phy_bus[] = {
...
#endif
int
bcm6300_a0_bmd_attach(int unit)
{
    int port;
    cdk_pbmp_t pbmp;
...
#if BMD_CONFIG_INCLUDE_PHY == 1
    bmd_phy_ability_get(unit, port, &ability);
...
/* CONFIG_MDK_BCA_END */
#if BMD_CONFIG_INCLUDE_PHY == 1
        bmd_phy_bus_set(unit, port, bcm6300_a0_phy_bus);
#endif
    }

...
/*
 * $Id: bcm6300_a0_bmd_port_mac_addr_remove.c,v 1.3 Broadcom SDK $
 * 
...
int
bcm6300_a0_bmd_port_mac_addr_remove(int unit, int port, int vlan, const bmd_mac_addr_t *mac_addr)
{
    BMD_CHECK_UNIT(unit);
    BMD_CHECK_VLAN(unit, vlan);
    BMD_CHECK_PORT(unit, port);

    return bcm6300_a0_arl_write(unit, -1, vlan, mac_addr);
}

...
/*
 * $Id: bcm6300_a0_bmd_reset.c,v 1.4 Broadcom SDK $
 * 
...
bcm6300_a0_bmd_reset(int unit)
{
    ...
    WATCH_DOG_CTRLr_EN_HW_RESETf_SET(wd_ctrl, 1);
    ...
    if (msec >= ROBO_RESET_MSEC) {
        CDK_WARN(("bcm6300_a0_bmd_reset[%d]: watchdog timeout\n", unit));
    }

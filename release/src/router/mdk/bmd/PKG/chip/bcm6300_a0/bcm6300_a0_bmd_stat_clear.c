...
/*
 * $Id: bcm6300_a0_bmd_stat_clear.c,v 1.3 Broadcom SDK $
 * 
...
} bcm6300_a0_counter_t;

int
bcm6300_a0_bmd_stat_clear(int unit, int port, bmd_stat_t stat)
{
    int ioerr = 0;
    bcm6300_a0_counter_t ctr;

...
/*
 * $Id: bcm6300_a0_bmd_rx.c,v 1.3 Broadcom SDK $
 * 
...
{
    int ioerr = 0;
    MII_PCTLr_t mii_pctl;

    ioerr += READ_MII_PCTLr(unit, &mii_pctl);
    MII_PCTLr_MIRX_BC_ENf_SET(mii_pctl, enable);
    MII_PCTLr_MIRX_MC_ENf_SET(mii_pctl, enable);
    MII_PCTLr_MIRX_UC_ENf_SET(mii_pctl, enable);
    ioerr += WRITE_MII_PCTLr(unit, mii_pctl);
...
int
bcm6300_a0_bmd_rx_start(int unit, bmd_pkt_t *pkt)
{
#if BMD_CONFIG_INCLUDE_DMA == 1
    int rv;
...
int
bcm6300_a0_bmd_rx_poll(int unit, bmd_pkt_t **ppkt)
{
#if BMD_CONFIG_INCLUDE_DMA == 1
    int rv = CDK_E_NONE;
...
int
bcm6300_a0_bmd_rx_stop(int unit)
{
#if BMD_CONFIG_INCLUDE_DMA == 1
    int rv;

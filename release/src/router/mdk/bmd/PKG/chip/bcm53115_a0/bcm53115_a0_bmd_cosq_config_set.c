...
/*
 * $Id: bcm53115_a0_bmd_cosq_config_set.c,v 1.2 Broadcom SDK $
 * 
...
int 
bcm53115_a0_bmd_cosq_config_set(
    int unit, 
    int numq)
{
    int ioerr = 0;
    ...
    if ((numq < 0) || (numq > NUM_EGRESS_QUEUES))
        return CDK_E_PARAM;

    ioerr += READ_QOS_TX_CTRLr(unit, &ctrl);
    QOS_TX_CTRLr_QOS_PRIORITY_CTRLf_SET(ctrl, numq-1);

...
int on_heavy_counts, on_hash_counts, on_light_counts, on_nntp_counts, on_ed2k_counts, total_nntp_counts, total_heavy_counts, total_light_counts, total_counts; //2012.06.27 eric added on_hash_counts
#define LOAD_CHECK_TIMEVAL	10	
#define UTILITY_CHECK_TIMEVAL	5
//#define MAX_ON_HEAVY	4
//#define MAX_ON_HEAVY	10
int MAX_ON_HEAVY;
#define MAX_ON_LIGHT	6
...
char  apps_dev_path[MAX_NAMELEN];

char lan_ip_addr[16],miscr_httpport_x_check[2],miscr_http_x_check[2],productid_check[16],wan_ip_check[16],ddns_enable_x_check[2],ddns_hostname_x_check[256],rfw_enable_x_check[2],device_type_check[16],utility_ver_check[32],local_domain_check[125],http_autologout_check[16];
...
typedef struct Request_Head{
        ...
        char  packetNum[HASHLEN];  // rest packet numbers //2008.7 Gavin ,for rtorrent
}Phead;

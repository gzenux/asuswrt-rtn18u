...
#define AES_INIT_ECB(ks_min, ks_def, ks_max, mode) \
...
#define AES_INIT_BASIC(ks_min, ks_def, ks_max, mode) \
  16, 16, { (ks_min), (ks_def), (ks_max) }, ssh_rijndael_ctxsize, \
  ssh_aes_init, ssh_aes_init, ssh_rijndael_start, \
  ssh_rijndael_ ## mode, ssh_aes_uninit, FALSE, 0, \
  NULL_FNPTR, NULL_FNPTR, NULL_FNPTR, NULL_FNPTR, NULL_FNPTR
#define AES_INIT_FEEDBACK(ks_min, ks_def, ks_max, mode1, mode2) \
  16, 16, { (ks_min), (ks_def), (ks_max) }, ssh_rijndael_ctxsize, \
  ssh_aes_init ## mode1, ssh_aes_init ## mode1, ssh_rijndael_start, \
...
#define AES_INIT_COUNTER(ks_min, ks_def, ks_max, mode1, mode2) \
  ...
  { "aes-ecb", AES_INIT_ECB(16, 16, 32, ecb) },
  { "aes128-ecb", AES_INIT_ECB(16, 16, 16, ecb) },
  { "aes192-ecb", AES_INIT_ECB(24, 24, 24, ecb) },
  { "aes256-ecb", AES_INIT_ECB(32, 32, 32, ecb) },
  ...
  { "aes-ccm",
    1, 16, { 16, 16, 32 }, ssh_ccm_aes_ctxsize,
    ssh_ccm_aes_init, ssh_ccm_aes_init,
    NULL_FNPTR, ssh_ccm_transform, NULL_FNPTR,
    TRUE, 16,
    ssh_ccm_auth_start, ssh_ccm_update,
    ssh_ccm_final, ssh_ccm_final_verify, NULL_FNPTR },

  { "aes128-ccm",
    1, 16, { 16, 16, 16 }, ssh_ccm_aes_ctxsize,
    ssh_ccm_aes_init, ssh_ccm_aes_init,
    NULL_FNPTR, ssh_ccm_transform, NULL_FNPTR,
    TRUE, 16,
    ssh_ccm_auth_start, ssh_ccm_update,
  ...
  { "aes192-ccm",
    1, 16, { 24, 24, 24 }, ssh_ccm_aes_ctxsize,
    ssh_ccm_aes_init, ssh_ccm_aes_init,
    NULL_FNPTR, ssh_ccm_transform, NULL_FNPTR,
    TRUE, 16,
    ssh_ccm_auth_start, ssh_ccm_update,
  ...
  { "aes256-ccm",
    1, 16, { 32, 32, 32 }, ssh_ccm_aes_ctxsize,
    ssh_ccm_aes_init, ssh_ccm_aes_init,
    NULL_FNPTR, ssh_ccm_transform, NULL_FNPTR,
    TRUE, 16,
    ssh_ccm_auth_start, ssh_ccm_update,
  ...
  { "rijndael-cbc",
    16, 16, { 0, 16, 32 }, ssh_rijndael_ctxsize,
    ssh_rijndael_init, ssh_rijndael_init,
    ssh_rijndael_start, ssh_rijndael_cbc, ssh_rijndael_uninit,
    FALSE, 0,
    NULL_FNPTR, NULL_FNPTR, NULL_FNPTR, NULL_FNPTR, NULL_FNPTR },
  { "rijndael-cfb",
    16, 16, { 0, 16, 32 }, ssh_rijndael_ctxsize,
    ssh_rijndael_init_fb, ssh_rijndael_init_fb,
    ssh_rijndael_start, ssh_rijndael_cfb, ssh_rijndael_uninit,
    FALSE, 0,
    NULL_FNPTR, NULL_FNPTR, NULL_FNPTR, NULL_FNPTR, NULL_FNPTR },
  { "rijndael-ofb",
    16, 16, { 0, 16, 32 }, ssh_rijndael_ctxsize,
    ssh_rijndael_init_fb, ssh_rijndael_init_fb,
    ssh_rijndael_start, ssh_rijndael_ofb, ssh_rijndael_uninit,
    FALSE, 0,
    NULL_FNPTR, NULL_FNPTR, NULL_FNPTR, NULL_FNPTR, NULL_FNPTR },
  { "rijndael-ctr",
    16, 16, { 0, 16, 32 }, ssh_rijndael_ctxsize,
    ssh_rijndael_init_fb, ssh_rijndael_init_fb,
    ssh_rijndael_start, ssh_rijndael_ctr, ssh_rijndael_uninit,
    FALSE, 0,
    NULL_FNPTR, NULL_FNPTR, NULL_FNPTR, NULL_FNPTR, NULL_FNPTR },
  ...
  { "des-ecb",
    ...
    ssh_des_start, ssh_des_ecb, ssh_des_uninit,
    FALSE, 0,
    NULL_FNPTR, NULL_FNPTR, NULL_FNPTR, NULL_FNPTR, NULL_FNPTR },
  { "des-cbc",
    8, 8, { 8, 8, 8 }, ssh_des_ctxsize,
  ...
  { "des-cfb",
    8, 8, { 8, 8, 8 }, ssh_des_ctxsize,
    ssh_des_init, ssh_des_init_with_key_check,
    ssh_des_start, ssh_des_cfb, ssh_des_uninit,
    FALSE, 0,
    NULL_FNPTR, NULL_FNPTR, NULL_FNPTR, NULL_FNPTR, NULL_FNPTR },
  { "des-ofb",
    8, 8, { 8, 8, 8 }, ssh_des_ctxsize,
    ssh_des_init, ssh_des_init_with_key_check,
    ssh_des_start, ssh_des_ofb, ssh_des_uninit,
    FALSE, 0,
    NULL_FNPTR, NULL_FNPTR, NULL_FNPTR, NULL_FNPTR, NULL_FNPTR },
#endif /* SSHDIST_CRYPT_DES */

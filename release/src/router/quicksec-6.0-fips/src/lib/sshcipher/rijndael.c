...
{
  SshRijndaelContext ctx = (SshRijndaelContext) context;
  unsigned char *ctx_iv = ctx->iv;
  SshUInt32 v[4], c[4], iv[4];

  iv[0] = SSH_GET_32BIT_LSB_FIRST(ctx_iv);
  iv[1] = SSH_GET_32BIT_LSB_FIRST(ctx_iv + 4);
  iv[2] = SSH_GET_32BIT_LSB_FIRST(ctx_iv + 8);
  iv[3] = SSH_GET_32BIT_LSB_FIRST(ctx_iv + 12);
  ...
  SSH_PUT_32BIT_LSB_FIRST(ctx_iv, iv[0]);
  SSH_PUT_32BIT_LSB_FIRST(ctx_iv + 4, iv[1]);
  SSH_PUT_32BIT_LSB_FIRST(ctx_iv + 8, iv[2]);
  SSH_PUT_32BIT_LSB_FIRST(ctx_iv + 12, iv[3]);
                                 ...
                                 const unsigned char *src, size_t len)
{
  ...
  if (ctx->for_encryption)
    {
      iv_0 = SSH_GET_32BIT_LSB_FIRST(ctx_iv);
      iv_1 = SSH_GET_32BIT_LSB_FIRST(ctx_iv + 4);
      iv_2 = SSH_GET_32BIT_LSB_FIRST(ctx_iv + 8);
      iv_3 = SSH_GET_32BIT_LSB_FIRST(ctx_iv + 12);
      ...
      SSH_PUT_32BIT_LSB_FIRST(ctx_iv, iv_0);
      SSH_PUT_32BIT_LSB_FIRST(ctx_iv + 4, iv_1);
      SSH_PUT_32BIT_LSB_FIRST(ctx_iv + 8, iv_2);
      SSH_PUT_32BIT_LSB_FIRST(ctx_iv + 12, iv_3);
    }
  else
    {
                                 ...
                                 const unsigned char *src, size_t len)
{
  ...
  ctr[0] = SSH_GET_32BIT(ctx_iv);
  ctr[1] = SSH_GET_32BIT(ctx_iv + 4);
  ctr[2] = SSH_GET_32BIT(ctx_iv + 8);
  ctr[3] = SSH_GET_32BIT(ctx_iv + 12);
  ...
  if (len)
    {
      ...
      t = SSH_GET_32BIT_LSB_FIRST(tmp + 1) ^ iv[1];
      SSH_PUT_32BIT_LSB_FIRST(tmp + 1, t);
      t = SSH_GET_32BIT_LSB_FIRST(tmp + 2) ^ iv[2];
      SSH_PUT_32BIT_LSB_FIRST(tmp + 2, t);
      t = SSH_GET_32BIT_LSB_FIRST(tmp + 3) ^ iv[3];
      SSH_PUT_32BIT_LSB_FIRST(tmp + 3, t);
  ...
  SSH_PUT_32BIT(ctx_iv, ctr[0]);
  SSH_PUT_32BIT(ctx_iv + 4, ctr[1]);
  SSH_PUT_32BIT(ctx_iv + 8, ctr[2]);
  SSH_PUT_32BIT(ctx_iv + 12, ctr[3]);

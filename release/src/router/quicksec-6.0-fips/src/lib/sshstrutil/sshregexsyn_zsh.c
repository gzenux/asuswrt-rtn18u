...
static const SshRexParseMap syntax_zsh =
{
  /* The standard map. */
  {
    SSH_REX_P_EOI,              /* NUL (0) */
    ...
    SSH_REX_P_PCNFA_ZSH_QUESTION_MARK,         /* ? (63) */
                ...
                /* The charset syntax map. */
  {
    ...
    SSH_REX_P_LITERAL,          /* ^_ (31) */
    SSH_REX_P_LITERAL,          /*   (32) */
    SSH_REX_P_CHARSET_COMPLEMENT_IF_FIRST, /* ! (33) */
    SSH_REX_P_LITERAL,          /* " (34) */
    SSH_REX_P_LITERAL,          /* # (35) */
    SSH_REX_P_LITERAL,          /* $ (36) */
    SSH_REX_P_LITERAL,          /* % (37) */
  ...
  SSH_REX_PARSE_FLAG_ALWAYS_ANCHOR
};

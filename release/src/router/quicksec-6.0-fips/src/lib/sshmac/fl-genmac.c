...
#include "fl-hmac.h"
#endif /* SSHDIST_CRYPT_SHA || SSHDIST_CRYPT_SHA256 || SSHDIST_CRYPT_SHA512 */
...
static const SshHashMacDefStruct ssh_mac_algorithms[] =
{
...
#ifdef SSHDIST_CRYPT_MD5
  { "hmac-md5", 16, FALSE, &ssh_hash_md5_def,
...
#endif /* SSHDIST_CRYPT_MD5 */
#ifdef SSHDIST_CRYPT_SHA
  { "hmac-sha1", 20, FALSE, NULL,
    fl_hmac_ctxsize, fl_hmac_sha1_init, fl_hmac_uninit,
    fl_hmac_start, fl_hmac_update, fl_hmac_final,
    fl_hmac_of_buffer, NULL },
  { "hmac-sha1-96", 12, FALSE,
    NULL,
    fl_hmac_ctxsize, fl_hmac_sha1_96_init, fl_hmac_uninit,
    fl_hmac_start, fl_hmac_update, fl_hmac_final,
    fl_hmac_of_buffer },
#endif /* SSHDIST_CRYPT_SHA */
#ifdef SSHDIST_CRYPT_SHA256
  {
    "hmac-sha256", 32, FALSE, NULL,
    fl_hmac_ctxsize, fl_hmac_sha256_init, fl_hmac_uninit,
    fl_hmac_start, fl_hmac_update, fl_hmac_final,
    fl_hmac_of_buffer, NULL },
  {
    "hmac-sha256-96", 12, FALSE, NULL,
    fl_hmac_ctxsize, fl_hmac_sha256_96_init, fl_hmac_uninit,
    fl_hmac_start, fl_hmac_update, fl_hmac_final,
    fl_hmac_of_buffer },
...
#ifdef SSHDIST_CRYPT_SHA256
  {
    "hmac-sha256-128", 16, FALSE, NULL,
    fl_hmac_ctxsize, fl_hmac_sha256_128_init, fl_hmac_uninit,
    fl_hmac_start, fl_hmac_update, fl_hmac_final,
    fl_hmac_of_buffer, NULL },
  {
    "hmac-sha224", 28, FALSE, NULL,
    fl_hmac_ctxsize, fl_hmac_sha224_init, fl_hmac_uninit,
    fl_hmac_start, fl_hmac_update, fl_hmac_final,
    fl_hmac_of_buffer, NULL },
  {
    "hmac-sha224-128", 16, FALSE, NULL,
    fl_hmac_ctxsize, fl_hmac_sha224_128_init, fl_hmac_uninit,
    fl_hmac_start, fl_hmac_update, fl_hmac_final,
    fl_hmac_of_buffer, NULL },
#endif /* SSHDIST_CRYPT_SHA256 */
#ifdef SSHDIST_CRYPT_SHA512
  {
    "hmac-sha384", 48, FALSE, NULL,
    fl_hmac_ctxsize, fl_hmac_sha384_init, fl_hmac_uninit,
    fl_hmac_start, fl_hmac_update, fl_hmac_final,
    fl_hmac_of_buffer, NULL },
  {
    "hmac-sha384-128", 16, FALSE, NULL,
    fl_hmac_ctxsize, fl_hmac_sha384_128_init, fl_hmac_uninit,
    fl_hmac_start, fl_hmac_update, fl_hmac_final,
    fl_hmac_of_buffer, NULL },
  {
    "hmac-sha384-192", 24, FALSE, NULL,
    fl_hmac_ctxsize, fl_hmac_sha384_192_init, fl_hmac_uninit,
    fl_hmac_start, fl_hmac_update, fl_hmac_final,
    fl_hmac_of_buffer, NULL },
  {
    "hmac-sha512", 64, FALSE, NULL,
    fl_hmac_ctxsize, fl_hmac_sha512_init, fl_hmac_uninit,
    fl_hmac_start, fl_hmac_update, fl_hmac_final,
    fl_hmac_of_buffer, NULL },
  {
    "hmac-sha512-128", 16, FALSE, NULL,
    fl_hmac_ctxsize, fl_hmac_sha512_128_init, fl_hmac_uninit,
    fl_hmac_start, fl_hmac_update, fl_hmac_final,
    fl_hmac_of_buffer, NULL },
  {
    "hmac-sha512-256", 32, FALSE, NULL,
    fl_hmac_ctxsize, fl_hmac_sha512_256_init, fl_hmac_uninit,
    fl_hmac_start, fl_hmac_update, fl_hmac_final,
    fl_hmac_of_buffer, NULL },
 ...
 const SshCipherMacBaseDefStruct ssh_ciphermac_base_rijndael_def =
   { 16, fl_cipher_aes_ctxsize, fl_cipher_aes_init_cbc, fl_cipher_aes_uninit,
     fl_aes_xcbc_mac };
#endif /* SSHDIST_CRYPT_RIJNDAEL */

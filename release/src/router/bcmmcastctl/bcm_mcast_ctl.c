...
static int bcm_mcast_ctl_show_config(void *pCmd, int argc, char *argv[])
{
   int    c;
   char  *optif = NULL;
   char  *optproto = NULL;
   ...
   else
   {
      ...
      if (dp != NULL)
      {
         while ( 1 )
         {
            ...
            snprintf(path, 64, "/sys/class/net/%s/bridge", ep->d_name);
            rc = stat(path, &st);
...
static int bcm_mcast_ctl_set_snoop_mode(void *pCmd, int argc, char *argv[])
{
   int    c;
   char  *optif = NULL;
   char  *optproto = NULL;
   ...
   mode = bcm_mcast_ctl_get_mode(optproto);
...
static int bcm_mcast_ctl_set_l2l_enable(void *pCmd, int argc, char *argv[])
{
   int    c;
   char  *optif = NULL;
   char  *optproto = NULL;
...
static int bcm_mcast_ctl_set_proto_rl(void *pCmd, int argc, char *argv[])
{
   int    c;
   char  *optif = NULL;
   char  *optproto = NULL;
...
static int bcm_mcast_ctl_blog_enable(void *pCmd, int argc, char *argv[])
{
   int    c;
   char  *opten = NULL;
   int    enable;

...
static int mcpdCtlGenericHandler(void *pCmd, int argc, char *argv[])
{
...
static int mcpdCtlGrpModeHandler(void *pCmd, int argc, char *argv[])
{
    t_MCPD_CTL_CMD      *pMcpdCmd = (t_MCPD_CTL_CMD *)pCmd;
...
static int mcpdCtlAdmissionHandler(void *pCmd, int argc, char *argv[])
{
    t_MCPD_CTL_CMD      *pMcpdCmd = (t_MCPD_CTL_CMD *)pCmd;

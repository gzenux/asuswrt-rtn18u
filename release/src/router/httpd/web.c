...
#ifdef CONFIG_BCMWL5
#if !defined(RTAC3200) && !defined(RTAC87U) && !defined(RTAC56U) && !defined(RTN18U)	// kludge
	if (fw_check() != 0)
		goto err;
#endif
#endif
...
#if !defined(RTAC3200) && !defined(RTAC87U)	// Kludge, requires 81116 or newer
...
#if defined(RTAC3200) || defined(RTAC87U) || defined(RTAC56U)	// Kludge for 382 models
int is_amas_support() {
	return 0;
}
#endif

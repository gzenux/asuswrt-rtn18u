...
extern void BCMROMFN(wlc_wpapsk_free)(wlc_info_t *wlc, wpapsk_t *wpa);
...
extern int BCMROMFN(wlc_wpa_cobble_pmk)(wpapsk_info_t *info, char *psk, size_t psk_len,
	uchar *ssid, uint ssid_len);
extern bool wlc_wpa_set_ucipher(wpapsk_t *wpa, ushort ucipher, bool wep_ok);
extern int BCMROMFN(wlc_wpa_set_pmk)(wlc_bsscfg_t *bsscfg, wpapsk_info_t *info,
